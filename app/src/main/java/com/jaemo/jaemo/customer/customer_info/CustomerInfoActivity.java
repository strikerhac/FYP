package com.jaemo.jaemo.customer.customer_info;
...
import com.jaemo.jaemo.customer.book_route.BookRouteActivity;
...
public class CustomerInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getString(R.string.customer_info_title));
    ...
    public void findDriver(View view){
        Intent intent = new Intent(getApplicationContext(), BookRouteActivity.class);
